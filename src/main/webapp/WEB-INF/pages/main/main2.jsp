...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black" style="margin-top: 10px; font:18px;">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item">
                    <a href="javascript:;" onclick="toShow('/path/layer/leaveList')">请假记录</a>
                    <%--<dl class="layui-nav-child">--%>
                    <%--<dd><a href="javascript:;"  >用户列表</a></dd>--%>
                    <%--</dl>--%>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="javascript:;" onclick="toShow('/path/layer/attendance')">缺勤记录</a>
                    <%--<dl class="layui-nav-child">--%>
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" onclick="toShow('/path/salary/salarylistEmp')">工资记录</a>
    ...
    %>
    <input type="text" value="<%=user.getUserNo().toString()%>" id="transfer" hidden="hidden">
    <script>
        //给子窗口传递数据
        function getdata(){
            return $("#transfer").val();
